...
| `ShareCardThemePlugin` | `Plugins/Sources/ClaudeStatisticsKit/ShareCardThemePlugin.swift` | `PluginRegistry.shareThemes` 桶有写无读；descriptor 还只有 id + displayName，缺 visual 字段（颜色/符号/mascot/decorationSymbols 等）让 plugin role 用自己的卡面 |
