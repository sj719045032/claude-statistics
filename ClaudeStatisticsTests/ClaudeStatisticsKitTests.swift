...
final class ClaudeContextWindowTests: XCTestCase {
    func testCurrentMillionTokenClaudeModels() {
        ...
        for model in models {
            stats.model = model
            XCTAssertEqual(stats.contextWindowSize, 1_000_000, model)
        }
...
final class PluginRegistryTests: XCTestCase {
    ...
    func testHostAPIVersionExposed() {
        XCTAssertEqual(SDKInfo.apiVersion, SemVer(major: 0, minor: 4, patch: 0))
    }
